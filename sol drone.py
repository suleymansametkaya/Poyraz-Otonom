...
def takeoff(irtifa):
    ...
    while soldrone.armed is not True:
...
def tara(x1,y1,x2,y2,x3,y3,x4,y4):
    ...
    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0, 0,0, x1, y1, 7))#cmd1
    ...
    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0, 0,0,x1, y_orta1, 7))#cmd3

    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0,0,0, x_orta2, y_orta1, 7))#cmd4
    ...
    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0,0,0, x_orta2, y1, 7))#cmd6

    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0,0,0, x_orta1, y1, 7))#cmd7
    ...
    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0,0,0, x_orta1, y_orta1, 7))#cmd9

    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0,0,0, x_orta3, y_orta1, 7))#cmd10
    ...
    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0,0,0, x_orta3, y1, 7))#cmd12

    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0,0,0, x4, y4, 7))#cmd13
    ...
    komut.add(Command(0, 0, 0, mavutil.mavlink.MAV_FRAME_GLOBAL_RELATIVE_ALT, mavutil.mavlink.MAV_CMD_NAV_WAYPOINT, 0, 0, 1, 0,0,0, x4, y_orta1, 7))#cmd15
...
time.sleep(1)
print(f"İha : " + str(soldrone.mode) + " moduna alindi.\n")
...
while True:
    ...
    time.sleep(2.5)
    print(f"Konum X : " + str(soldrone.location.global_relative_frame.lat))
    print(f"Konum Y : " + str(soldrone.location.global_relative_frame.lon))
    print(f"Konum Z : " + str(soldrone.location.global_relative_frame.alt))
    print("air speed : " + str(soldrone.airspeed))
    print("ground speed : " + str(soldrone.groundspeed))
    print("----------------------------")
